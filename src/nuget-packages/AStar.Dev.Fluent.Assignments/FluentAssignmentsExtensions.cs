...
/// <summary>
///     The <see cref="FluentAssignmentsExtensions" /> class contains the initial extension methods. Over time, this may be
...
public static class FluentAssignmentsExtensions
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of the parameter for the assignment</typeparam>
