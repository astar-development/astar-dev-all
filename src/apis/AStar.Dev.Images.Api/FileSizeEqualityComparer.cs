...
internal sealed class FileSizeEqualityComparer : IEqualityComparer<FileSize>
{
    /// <summary>
    ...
    {
        int hashCode = fileSize.Height.GetHashCode() ^ fileSize.FileLength.GetHashCode() ^ fileSize.Width.GetHashCode();
