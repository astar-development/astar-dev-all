...
public sealed class ConfigurationManagerExtensionsShould
{
    ...
    public void ReturnAnEmptyConfigurationWhenTheConfigurationKeyDoesNotExist()
    {
        ...
        ApiConfiguration? configuration = sut.GetValidatedConfigurationSection<ApiConfiguration>("Some Key That Does Not Exist");
    ...
    public void ReturnTheExpectedConfigurationWhenTheConfigurationKeyExists()
    {
        ...
        ApiConfiguration configuration = sut.GetValidatedConfigurationSection<ApiConfiguration>("apiConfiguration")!;
